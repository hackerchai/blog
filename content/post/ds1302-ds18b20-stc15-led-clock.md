...
![1](/images/2016/08/ds1302-clock-demo-1.webp) 

![2](/images/2016/08/ds1302-clock-demo-2.webp)

![3](/images/2016/08/ds1302-clock-demo-3.webp)
...
![数码管](/images/2016/08/digital-tube.webp)
...
![按键消抖](/images/2016/08/button-shake.webp)
...
![DS1302的引脚封装图](/images/2016/08/ds1302-pcb.webp)
...
下面是这种芯片的引脚图和常用电路： 
![引脚图](/images/2016/08/ds1302-pin.webp)

![常用电路](/images/2016/08/ds1302-circuit.webp)
...
![电路](/images/2016/08/ds1302-circuit-1.webp)

我们希望时钟即使掉电也能走时，好在它同样提供了这个功能，下图的电容我们换做了RS2302纽扣电池，RS2302电流恒定，自放电小，使用时间长： 
![电路](/images/2016/08/ds1302-circuit-2.webp)
...
![字节图](/images/2016/08/ds1302-command.webp)
...
![寄存器](/images/2016/08/ds1302-register.webp)
...
![单字节写入操作](/images/2016/08/ds1302-spi-sequence.webp)

再看单字节读出操作： 
![单字节读出操作](/images/2016/08/ds1302-single-byte-read.webp)
...
![DS18B20封装及引脚图](/images/2016/08/ds18b20-pin.webp)

![DS18B20封装及引脚图](/images/2016/08/ds18b20-pin-desc.webp)

### DS18B20温度芯片电路连接

![芯片电路连接](/images/2016/08/ds18b20-circuit.webp)
...
*   DS18B20内部主要寄存器的逻辑图 
![DS18B20内部结构框图](/images/2016/08/ds18b20-struture.webp)

结合图中的内部寄存器框图，我们先简单说一下DS18B20芯片的主要寄存器工作流程，而在对DS18B20工作原理进行详细说明前，有必要先上几张相关图片：

*   DS18B20内部寄存器结构图

![DS18B20寄存器结构示意图]](/images/2016/08/ds18b20-internal-register.webp)

*   DS18B20主要寄存器数据格式图示

![DS18B20主要寄存器数据格式](/images/2016/08/ds18b20-main-register.webp)

*   DS18B20通讯指令图

![DS18B20-ROM指令](/images/2016/08/ds18b20-rom-command.webp)
...
![DS18B20上电初始化时隙图](/images/2016/08/ds18b20-init-timeline.webp)
...
![总线控制器从DS18B20寄存器读数据时隙图](/images/2016/08/ds18b20-register-timeline.webp)
...
*   数据写入时通讯总线的时隙图 
![总线控制器向DS18B20写数据时隙图](/images/2016/08/ds18b20-cbus-timeline.webp)
...
2.发送一条 ROM 指令
![发送一条 ROM 指令](/images/2016/08/ds18b20-send-one-command.webp)

3.发送存储器指令 
![发送存储器指令](/images/2016/08/ds18b20-send-storage-command.webp)
...
![存储格式](/images/2016/08/ds18b20-storage-binary.webp)
...
![存储格式](/images/2016/08/ds18b20-storage-binary-expalin.webp)
